...
export const setState = (property) => (store, payload) => {
  store[property] = payload;
};
export const updateState = (property) => (store, payload) => {
  store[property] = {
    ...store[property],
    ...payload,
  };
...
export const pushState = (property) => (store, payload) => {
 ...
 */
const createNamespaceMap = (actionCreator) => (
  keys = [],
  namespaceGetter = (vm) => vm.namespace
) => {
